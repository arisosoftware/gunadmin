...
public interface Constants {
	 ...
	 * 定义JSON形式的业务处理结果
	 */
	String FAIL = JSON_PRE + "fail" + JSON_END, ERROR = JSON_PRE + "error" + JSON_END,
			SUCCESS = JSON_PRE + "success" + JSON_END, TRUE = JSON_PRE + "true" + JSON_END,
			FALSE = JSON_PRE + "false" + JSON_END, LOCKED = JSON_PRE + "locked" + JSON_END,
			EXIST = JSON_PRE + "exist" + JSON_END;
