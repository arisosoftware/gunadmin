...
public class RSAHelper {
	...
	public static byte[] decryptData(byte[] encryptedData, PrivateKey privateKey) {
		try {
			Cipher cipher = Cipher.getInstance(RSAHelper.RSA);
	...
	public static KeyPair generateRSAKeyPair() {
		return RSAHelper.generateRSAKeyPair(1024);
	}
	...
	public static KeyPair generateRSAKeyPair(int keyLength) {
		try {
			KeyPairGenerator kpg = KeyPairGenerator.getInstance(RSAHelper.RSA);
	...
	public static PrivateKey getPrivateKey(byte[] keyBytes) throws NoSuchAlgorithmException, InvalidKeySpecException {
		...
		KeyFactory keyFactory = KeyFactory.getInstance(RSAHelper.RSA);
	...
	public static PrivateKey loadPrivateKey(InputStream in) throws Exception {
		try {
			return RSAHelper.loadPrivateKey(RSAHelper.readKey(in));
		} catch (IOException e) {
	...
	public static PublicKey loadPublicKey(InputStream in) throws Exception {
		try {
			return RSAHelper.loadPublicKey(RSAHelper.readKey(in));
		} catch (IOException e) {
...
//    System.out.println(new String(bytes1));
	...
	public static byte[] signData(byte[] data, PrivateKey priKey) {
		return RSAHelper.signData(data, priKey, "SHA1withRSA");
	}
	...
	public static boolean verifySign(byte[] data, byte[] sign, PublicKey pubKey) {
		return RSAHelper.verifySign(data, sign, pubKey, "SHA1withRSA");
	}
